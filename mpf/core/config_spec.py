...
extra_ball_groups:
    ...
    enabled: single|bool|True
    events_when_disabled: single|bool|False

    award_extra_ball_events: dict|str:ms|None
    award_lit_extra_ball_events: dict|str:ms|None
    light_extra_ball_events: dict|str:ms|None
